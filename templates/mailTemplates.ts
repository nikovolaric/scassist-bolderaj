    ...
    <mj-section background-color="#ffffff" background-repeat="repeat" background-size="auto" padding-bottom="70px" padding-top="30px" padding="20px 0px 20px 0px" text-align="center">
      <mj-column>
        ...
        <mj-text align="left" color="#797e82" font-size="13px" line-height="22px" padding-bottom="0px" padding-left="50px" padding-right="50px" padding-top="0px" padding="0px 25px 0px 25px" font-family="SuorceSans, sans-serif">
          ...
          <p style="margin: 10px 0; text-align: center;">Več o pogojih vnovčitve darilnih bonov si lahko prebereš na <a href="http://localhost:5173/terms-conditions">povezavi.</a></p>
  ...
  <mj-body background-color="#f8f8f8">
    ...
    <mj-section background-color="#ffffff" background-repeat="repeat" background-size="auto" padding-bottom="70px" padding-top="30px" padding="20px 0px 20px 0px" text-align="center">
      <mj-column>
        ...
        <mj-button background-color="#ffde00" color="#000000" font-weight="600" href="http://localhost:5173/resetpassword/${token}">Ponastavi tukaj</mj-button>
      </mj-column>
    </mj-section>
  </mj-body>
</mjml>`;
  ...
  <mj-body background-color="#f8f8f8">
    ...
    <mj-section background-color="#ffffff" background-repeat="repeat" background-size="auto" padding-bottom="70px" padding-top="30px" padding="20px 0px 20px 0px" text-align="center">
      <mj-column>
        ...
        <mj-button background-color="#ffde00" color="#000000" font-weight="600" href="http://localhost:5173/setchildauth/${token}">Nastavi tukaj</mj-button>
      </mj-column>
    </mj-section>
  </mj-body>
</mjml>`;
  ...
  <mj-body background-color="#f8f8f8">
    ...
    <mj-section background-color="#ffffff" background-repeat="repeat" background-size="auto" padding-bottom="70px" padding-top="30px" padding="20px 0px 20px 0px" text-align="center">
      <mj-column>
        <mj-text align="left" color="#797e82" font-size="13px" line-height="22px" padding-bottom="0px" padding-left="50px" padding-right="50px" padding-top="0px" padding="0px 25px 0px 25px">
          <h1 style="text-align:center; color: #000000; line-height:32px" font-family="SuorceSans, sans-serif">Živijo,</h1>
          <h1 style="text-align:center; color: #000000; line-height:20px; font-size:16px; font-weight:400;" font-family="SuorceSans, sans-serif">tvoja registracija je že skoraj dokončana. Za zaključek postopka potrdi svih elektronski naslov s klikom na spodnji gumb.</h1>
        </mj-text>
        <mj-button background-color="#ffde00" color="#000000" font-weight="600" href="http://localhost:5173/setchildauth/${token}">Potrdi elektronski naslov</mj-button>
      </mj-column>
    </mj-section>
  </mj-body>
</mjml>`;
